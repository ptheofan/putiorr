...
export function normalizeTransfer(transfer) {
  ...
  return {
    ...
    peers: Number(transfer.peers_sending_to_us ?? transfer.peersSendingToUs ?? 0),
    ...
    downloadSpeed: Number(transfer.down_speed ?? transfer.downSpeed ?? 0),
    uploadSpeed: Number(transfer.up_speed ?? transfer.upSpeed ?? 0),
